  ...
  return (
    <main className="container">
      <section className="hero">
        ...
        <p className="lead">
          Practical chart analysis focused on breakouts, support zones,
          price action and clear buy-or-sell frameworks. Explore each stock
          category and watch the original YouTube analysis.
        </p>
          ...
          {(topics || []).map((t: any) => (
            ...
            >
              <div className="cardbody">
                ...
                <p className="small">
                  {t.description ||
                    `Latest ${t.name} stock analysis and videos.`}
                </p>
              </div>
            </Link>
          ))}
